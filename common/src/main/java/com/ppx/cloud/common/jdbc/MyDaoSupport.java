...
public class MyDaoSupport extends JdbcDaoSupport {
    ...
    protected int insertEntity(Object bean) {
        ...
        StringBuilder b = new StringBuilder("insert into ").append(getTableName(bean))
                .append("(").append(StringUtils.collectionToCommaDelimitedString(colList))
                .append(")values(").append(StringUtils.collectionToCommaDelimitedString(questionList)).append(")");
    ...
    protected int insertEntity(Object bean, String... uniqueColNames) {
        ...
        StringBuilder b = new StringBuilder("insert into ").append(getTableName(bean))
                .append("(").append(StringUtils.collectionToCommaDelimitedString(colList)).append(")")
                .append(" select ").append(StringUtils.collectionToCommaDelimitedString(questionList))
                .append(" from dual where not exists (select 1 from ").append(getTableName(bean))
                .append(" where ").append(StringUtils.collectionToDelimitedString(uniqueColNameList, " and ")).append(")");
    ...
    private int updateNoUnique(Object bean, LimitRecord limitRecord) {
        ...
        StringBuilder b = new StringBuilder("update ").append(getTableName(bean)).append(" set ")
                .append(StringUtils.collectionToCommaDelimitedString(colList))
                .append(" where ").append(idSql);
        if (limitRecord != null) {
    ...
    private int updateUnique(Object bean, LimitRecord limitRecord, String... uniqueColNames) {
        ...
        StringBuilder b = new StringBuilder("update ").append(tableName)
                .append(" join (select ? ").append(idColName).append(" from dual where not exists (select 1 from ")
                .append(tableName).append(" where ")
                .append(StringUtils.collectionToDelimitedString(uniqueColNameList, " and ")).append(" and ")
                .append(idColName).append("!=?)) t").append(" set ")
                .append(StringUtils.collectionToCommaDelimitedString(colList)).append(" where ")
                .append(tableName).append(".").append(idColName).append("=t.").append(idColName);
        if (limitRecord != null) {
