...
public class PasswordServiceImpl extends MyDaoSupport {
    ...
    public int updatePassword(String oldPassword, String newPassord) {
        ...
        Map<String, Object> map = getJdbcTemplate()
                .queryForMap("select login_password from merchant_account where account_id = ?", accoutId);
        ...
        // 更新密码
        int r = getJdbcTemplate().update("update merchant_account set login_password = ?, modified = now() where account_id = ?",
