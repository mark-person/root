...
public final class Logger implements org.slf4j.Logger, LocationAwareLogger, AppenderAttachable<ILoggingEvent>, Serializable {
    ...
    private void buildLoggingEventAndAppend(final String localFQCN, final Marker marker, final Level level, final String msg, final Object[] params,
        ...
        // dengxz 记录log和marker(Throwable t有值是，不传入addLog，传入setThrowable)
        // debug由MonitorConfig.isDebug控制
        AccessLog accessLog = MonitorContext.getAccessLog();
        if (accessLog != null) {
            if (marker != null) {
            ...
            if (t != null) {
                ...
                if (MonitorConfig.IS_DEBUG) {
                    accessLog.addLog(DateUtils.getHHMmSsSss() + le.toString() + classMsg);
                }
